...
import { DrawLine, Parallax, Reveal, ScrollProgress, ScrollSpread } from '@/components/landing/ScrollEffects'
    ...
    <>
      ...
      <div className="flex flex-col gap-16">
        ...
        <section id="overview" className="relative">
          {/* Parallax hero halo (decorative only) */}
          <Parallax
          ...
          <div className="grid gap-10 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,1fr)] items-start">
            ...
            {/* Preview — reveal + tiny parallax glow behind it */}
        ...
        {/* FINAL CTA */}
        <Reveal>
          <section id="pricing" className="relative rounded-2xl border border-slate-800/60 bg-[#151618] px-6 py-6 overflow-hidden">
            <Parallax

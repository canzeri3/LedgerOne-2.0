/* =============================================================
   LedgerOne · Laptop product preview
   Reusable Mac-style laptop chassis containing a compact
   render of the Portfolio dashboard. Used on home + platform.
   ============================================================= */
const { useState: _useState, useEffect: _useEffect, useRef: _useRef } = React;

function L1PortfolioSnapshot() {
  const sparkPath = (() => {
    ...
    <div className="lp-portfolio">
      <aside className="lp-side">
        <div className="lp-side-brand">
          <img src="assets/ledgerone-logo.png" alt="" />
        </div>
        <div className="lp-side-grp">
          ...
          <div className="lp-side-item">
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="9" /><circle cx="12" cy="12" r="5" /><circle cx="12" cy="12" r="1" /></svg>
            <span>Planner</span>
          </div>
          <div className="lp-side-item">
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M3 7a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v0H5a2 2 0 0 0-2 2z" /><rect x="3" y="7" width="18" height="12" rx="2" /><circle cx="16.5" cy="13" r="1.2" /></svg>
            <span>Portfolio</span>
          </div>
          <div className="lp-side-item">
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><rect x="5" y="3" width="14" height="18" rx="2" /><path d="M9 8h6M9 12h6M9 16h4" /></svg>
            <span>Audit Log</span>
          </div>
          <div className="lp-side-item">
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M14 3v5h5" /><path d="M14 3H7a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V8z" /></svg>
            <span>CSV</span>
          </div>
          <div className="lp-side-item">
          ...
          <div className="lp-side-item">
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="9" /><path d="M9.1 9a3 3 0 1 1 5.2 2c-.9.9-1.8 1.4-1.8 2.5" /><line x1="12" y1="17" x2="12.01" y2="17" /></svg>
        ...
        <div className="lp-coin-list">
          ...
          { s: 'SOL', n: 'Solana', r: 7 }].
          map((c, i) =>
          <div className="lp-coin" key={i}>
              <span className="cs">{c.s}</span>
              <span className="cn">{c.n}</span>
              <span className="rk">#{c.r}</span>
              {c.fav && <svg className="star" width="12" height="12" viewBox="0 0 24 24" fill="currentColor" stroke="none"><path d="M12 2l2.9 6.1 6.7.9-4.9 4.6 1.2 6.6L12 17.8 6.1 20.8l1.2-6.6L2.4 9l6.7-.9z" /></svg>}
            </div>
          )}
        </div>
      </aside>
        ...
        <div className="lp-content">
          ...
          <div className="lp-kpi-row">
            <div className="lp-kpi">
              ...
              <div className="val">$248,920.47</div>
              <div className="delta pos">↗ +1.29%</div>
            </div>
            <div className="lp-kpi">
              <div className="lbl">30D Performance</div>
              <div className="val">+12.84%</div>
              <div className="delta neut">vs. BTC +4.1pt</div>
            </div>
            <div className="lp-kpi">
              <div className="lbl">Cash on hand</div>
              <div className="val">$18,402.00</div>
              <div className="delta neut">7.4% of NAV</div>
            </div>
            <div className="lp-kpi">
              <div className="lbl">Drawdown · 90D</div>
              <div className="val">+31.21%</div>
              <div className="delta neg" style={{ color: "rgb(62, 207, 164)" }}>↘ within cap</div>
            </div>
          </div>
          <div className="lp-chart">
            ...
            <svg viewBox="0 0 900 240" preserveAspectRatio="none" className="lp-chart-svg">
              ...
              <path d={sparkPath + ` L 900,240 L 0,240 Z`} fill="url(#lpFill2)" />
              <path d={sparkPath} fill="none" stroke="#9B8BFF" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
...
function L1HeroLaptop({ children }) {
  return (
...
Object.assign(window, { L1PortfolioSnapshot, L1HeroLaptop });
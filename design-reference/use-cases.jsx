...
function CasesHeader() {
  return (
    <section className="l1-pageheader" data-screen-label="01 Cases header">
...
function FeaturedCase() {
  return (
    <section className="l1-section" data-screen-label="02 Featured" style={{ paddingTop: 40 }}>
      <div className="l1-wrap">
        <L1SectionHead
...
function PersonaGrid() {
  const personas = [
  {
    ...
    stats: [
    { v: "4Y+", l: "Horizon" },
    { v: "Zero", l: "Manual calculations" },
    { v: "Auto", l: "Drawdown response" }]
  ...
  },
  {
    ...
    stats: [
    { v: "1 input", l: "Risk profile" },
    { v: "Auto", l: "Configuration" },
    { v: "Cycle", l: "Education" }]

  }];

  return (
    <section className="l1-section" data-screen-label="03 Personas" style={{ paddingTop: 32 }}>
      <div className="l1-wrap">
        <L1SectionHead
          eyebrow="Who it's for"
          title="Four ways the engine earns its keep."
          body="The shape of the framework adapts. The discipline at its core does not." />
...
function MiniCases() {
  ...
  {
    seg: "INDIVIDUAL · 7Y",
    title: "From scattered notes to one clear record.",
    body: "A solo investor logged years of buys and sells across several exchanges into one place — finally seeing cost basis, gains, and a plan in a single view.",
    res: "7 years of history, reconciled."
  },
  {
    seg: "HOUSEHOLD · MULTI-ASSET",
    title: "One record the whole household agrees on.",
    body: "A family cut quarterly reviews from six hours to ninety minutes — one shared record of every position, decision, and rule, with no more debating which spreadsheet was right.",
    res: "−74% time-to-review."
  },
  {
    seg: "ADVISOR · FAMILY OFFICE",
    title: "Every recommendation, documented and explainable.",
    body: "An advisor pairs each allocation decision with the LedgerOne framework — explicit rules, expected behaviour, and a full audit trail clients can follow.",
    res: "Client confidence, on the record."
  },
  {
    seg: "QUANT · INDIVIDUAL",
    title: "Frameworks that survive the next bear.",
    body: "An ex-quant rebuilt his rule set against eight years of data. Three rules made the cut. Two were removed. None were guessed.",
    res: "Sharpe +0.42 vs. prior set."
  },
  {
    seg: "OPS · FAMILY OFFICE",
    title: "Tax season, but quiet.",
    body: "Per-lot HIFO accounting handed to the CPA as one PDF. The CPA called back with two questions. There used to be twenty.",
    res: "2 follow-ups vs. ~20."
  },
  {
    seg: "NEW · ALLOCATOR",
    title: "First crypto allocation. No drama.",
    body: "A new digital-asset investor entered with a single balanced profile and a fixed capital amount. The engine handled deployment across two months of weakness. They watched, not managed.",
    res: "Zero manual trades in 90 days."
  }];

  return (
    <section className="l1-section" data-screen-label="04 Mini cases" style={{ paddingTop: 0 }}>
      <div className="l1-wrap">
        <L1SectionHead
          eyebrow="In the field"
          title="The smaller wins, recorded for the record." />
...
function TestimonialRow() {
  const items = [
  {
    q: "The execution alone justified the migration. We finally have a record that doesn't depend on memory — or on someone's mood that morning.",
    n: "Marcus Aldridge",
    r: "Family portfolio · Canada",
    a: "MA"
  },
  {
    q: "It's the only crypto tool I've used that doesn't try to make me trade more. The opposite, actually.",
    n: "Yuki Tanaka",
    r: "Investor · Tokyo",
    a: "YT"
  },
  {
    q: "Our treasury proposals exit LedgerOne with the framework attached. Governance picked it up immediately — nobody asks for picks anymore, they ask about the rule set.",
    n: "Devin Reyes",
    r: "Small investing group · USA",
    a: "DR"
  }];

  return (
    <section className="l1-section" data-screen-label="05 Testimonials" style={{ paddingTop: 0 }}>
      <div className="l1-wrap">
        <L1SectionHead
          eyebrow="Heard from the desk"
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 16 }}>
          ...
          <div key={i} style={{ background: 'var(--color-bg-surface)', border: '1px solid var(--color-border)', padding: '36px 32px', display: 'flex', flexDirection: 'column', gap: 20, minHeight: 280, borderRadius: 2 }}>
              <div style={{ fontFamily: 'var(--font-display)', fontSize: 36, lineHeight: 0.5, color: 'var(--color-accent-purple)', height: 14 }}>"</div>
              <div style={{ fontFamily: 'var(--font-display)', fontWeight: 500, fontSize: 17, lineHeight: 1.45, color: 'var(--color-text-primary)', flex: 1, textWrap: 'balance' }}>
                {t.q}
              </div>
